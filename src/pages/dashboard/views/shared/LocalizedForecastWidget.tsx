    ...
    <div className="forecast-widget">
      ...
      <div className="forecast-main">
        <div className="forecast-identity">
          ...
          <span className="forecast-sublocation">
            {currentWeather.subLocation}
          </span>
        ...
        <div className="forecast-metrics">
          <div className="forecast-metric-chip">
            ...
            <strong className="forecast-metric-val">
        ...
        <div className="forecast-hourly-strip">
          {hours.map((item, idx) => (
            <div key={idx} className="hourly-cell">
              <span className="hourly-cell__time">
                {item.time}
              </span>
              ...
              <span className="hourly-cell__temp">
                {item.temp ?? 28}°
              </span>

              <span className="hourly-cell__pop">
                {item.pop || (
                  item.rainMm
                    ? `${item.rainMm}mm`
                    : '80%'
